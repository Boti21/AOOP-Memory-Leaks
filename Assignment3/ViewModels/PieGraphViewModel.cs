...
{
    public override string GraphType => "Pie";
    private ObservableCollection<ISeries> series = 
        new ObservableCollection<ISeries> { new PieSeries<double> { Values = new ObservableCollection<double> { 0, 0, 0 } } };
    ...
    public override LabelVisual Title { get; set; } = new() { Text = "Pie Chart" };
