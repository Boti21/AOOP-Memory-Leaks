...
public class LoginViewModel : ViewModelBase
{
    ...
    public void login () {
        ...
        if (studentChecked && !teacherChecked) _viewModel.CurrentView = _viewModel.StudentView;
        else _viewModel.CurrentView = _viewModel.TeacherView;
    ...
    //     bool loginSuccessful = username == null ? false : (password == null ? false : (_model.login(username, password) == 1));
